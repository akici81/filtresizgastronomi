          ...
          filtered.map((article) => (
            ...
            >
              ...
              <div style={{ display: 'flex', gap: 8, justifyContent: 'flex-end' }}>
                <ActionBtn onClick={() => toggleFeatured(article)} color={article.is_featured ? 'var(--red)' : 'var(--muted)'} title="Öne Çıkar">★</ActionBtn>
                <ActionBtn onClick={() => toggleEditorsPick(article)} color={article.is_editors_pick ? '#8b5cf6' : 'var(--muted)'} title="Editör Seçimi">✦</ActionBtn>
                <ActionBtn onClick={() => router.push(`/admin/articles/${article.id}`)} color={'var(--dim)'} title="Düzenle">✎</ActionBtn>
